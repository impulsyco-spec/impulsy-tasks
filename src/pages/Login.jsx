    ...
    <div className="min-h-screen flex bg-black font-sans text-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#050505] border-r border-[#1c1c1c] flex-col justify-between p-16 relative overflow-hidden">
        ...
        <div className="relative z-10 flex gap-4">
          <div className="bg-[#0c0c0c] border border-[#1c1c1c] rounded-2xl p-6 flex-1 hover:border-[rgb(var(--primary))]/30 transition-all">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                ...
                required
                className="w-full bg-[#0c0c0c] border border-[#1c1c1c] rounded-2xl px-5 py-3.5 text-sm font-medium text-white focus:outline-none focus:ring-1 focus:ring-[rgb(var(--primary))]/50 focus:border-[rgb(var(--primary))]/50 transition-all placeholder:text-[rgb(var(--text-muted))]"
